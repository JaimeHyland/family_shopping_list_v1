...
class Command(BaseCommand):
    help = 'Set products, list items, shops and categories with null value for current to True'  # noqa
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(self.style.SUCCESS(
            f"Updated slugs for {null_current_products.count()} products."
        ))
        ...
        self.stdout.write(self.style.SUCCESS(
            f"Updated slugs for {null_current_categories.count()} categories."
        ))
        ...
        self.stdout.write(self.style.SUCCESS(
            f"Updated slugs for {null_current_shops.count()} shops."
        ))
